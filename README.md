...
**고신영** : 얼리버드 티켓을 받기 위해 활동을 서둘러 진행한 경우도 있었지만, 학부생으로서 놓칠 수 있었던 여러 기회들을 접할 수 있었습니다. 이와 같은 기회를 1학년 때 알았더라면 더 큰 도움이 되었을 것 같다는 아쉬움이 있습니다. 소프트웨어학부를 복수전공하게 된 계기는 유전자 서열과 단백질을 AI와 컴퓨터를 활용하여 분석할 수 있는 역량을 키우고자 했던 것이었지만, 지금까지 그 목표보다는 전공 요건을 위한 학점 채우기에 급급했던 것 같습니다. 교수님과의 면담 등 여러 활동을 통해 구체적인 목표에 대한 고민을 할 수 있었고, 덕분에 제 진로와 방향이 더욱 명확진 것 같습니다.
